 ...
 */
class AlephbaWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(loadTitlePref(this@AlephbaWidgetConfigureActivity, appWidgetId))
    }

}

private const val PREFS_NAME = "com.example.android.alephba.AlephbaWidget"
